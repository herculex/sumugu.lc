...
public class AlarmUntils {
    ...
    public String SetAlarmClock(Activity activity,Calendar calendar,boolean repeat,long interval,String actionId)
    {
...
//        calendar.set(year, month, day, hour, minute, 0);
    ...
    public String CancelAlarmClock(Activity activity,Calendar calendar,String actionId)
    {
        int year,month,day,hour,minute,second;
        // 获取设置日期的年，月，日，时，分
        year = calendar.get(Calendar.YEAR);
